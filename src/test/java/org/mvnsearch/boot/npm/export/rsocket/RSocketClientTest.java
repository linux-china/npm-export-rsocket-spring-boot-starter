...
public class RSocketClientTest {
    ...
    public static void setUp() throws Exception {
        rsocket = RSocketFactory
                ...
                .transport(UriTransportRegistry.clientForUri("ws://127.0.0.1:8080/rsocket"))
                .start()
                .block();
    }
    ...
    public void testRequestResponse() throws Exception {
        CompositeByteBuf compositeByteBuf = compositeMetadataWithRouting("org.mvnsearch.user.AccountService.findById");
